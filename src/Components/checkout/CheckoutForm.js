    ...
    <section className={`borderRadius ${checkout.whiteSection}`}>
      ...
      <form id='checkoutForm' action=''>
        ...
        <div className={checkout.gridWrapper}>
          ...
          <div>
            <input id='eMoney' type='radio' value='eMoney' name='paymentMethod' checked className={checkout.inputRadio} />
            ...
            <input id='cash' type='radio' value='cash' name='paymentMethod' className={checkout.inputRadio} />
            <div className={`borderRadius ${checkout.inputRadioWrapper}`}>
